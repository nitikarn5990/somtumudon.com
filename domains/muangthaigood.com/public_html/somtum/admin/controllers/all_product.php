...
<?php if ($_GET['action'] == "add" || $_GET['action'] == "edit") { ?>
    ...
    ?>
            <div class="da-panel collapsible">
                <div class="da-panel-header"> <span class="da-panel-title"> <i class="icol-<?php echo ($products_message->GetPrimary() != '') ? 'application-edit' : 'add' ?>"></i> <?php echo ($products_message->GetPrimary() != '') ? 'แก้ไข' : 'เพิ่ม' ?> รายละเอียดหน้าสินค้า </span> </div>
