                ...
                <div class="da-panel-content da-form-container">
                    <form id="validate" enctype="multipart/form-data" action="<?php echo ADDRESS_ADMIN_CONTROL ?>branch<?php echo ($branch->GetPrimary() != '') ? '&id=' . $branch->GetPrimary() : ''; ?>" method="post" class="da-form">
                        <?php if ($branch->GetPrimary() != ''): ?>
                            ...
                            <input type="hidden" name="image" value="<?php echo $branch->GetValue('image') ?>" />
                             <input type="hidden" name="image_map" value="<?php echo $branch->GetValue('image_map') ?>" />
                        <?php endif; ?>
                        <div class="da-form-inline">
                            <div class="da-form-row">
                                <label class="da-form-label">ชื่อสาขา<span class="required">*</span></label>
                            ...
                            <fieldset class="da-form-inline">
                                        ...
                                        <ul style=" list-style-type: none;" class="da-form-list">
                                            <ul>
                                                <li> 
                                                    <span class="">
                                                        <?php if ($branch->GetPrimary() != '') { ?>
                                                            <img src="<?php echo ADDRESS_SLIDES . $branch->getDataDesc("image", "id = " . $branch->GetPrimary()) ?>" alt="<?php echo $branch->GetValue('alt') ?>" style="max-width: 100%;" class="img-thumbnail"> 
                                                        <?php } ?>
                                                    </span> 
                                                </li>
                                            </ul>
                                ...
                                <div class="da-form-row">
                                    ...
                                    <div class="da-form-item large" id="filecopy"> <span class="formNote"><strong>Alt tag</strong> </span>
                                        <input type="text" placeholder="" name="alt" value="<?php echo $branch->GetValue('alt') ?>" >
                            ...
                            <fieldset class="da-form-inline">
                                <legend><i class="fa fa-map"></i>&nbsp;&nbsp;อัพโหลดภาพ แผนที่</legend>
                                <div class="da-form-row">
                                    <label class="da-form-label">ไฟล์ที่อัพโหลด</label>
                                    <div class="da-form-item large">
                                        <ul style=" list-style-type: none;" class="da-form-list">
                                            <ul>
                                                <li> 
                                                    <span class="">
                                                        <?php if ($branch->GetPrimary() != '') { ?>
                                                            <img src="<?php echo ADDRESS_SLIDES . $branch->getDataDesc("image_map", "id = " . $branch->GetPrimary()) ?>" alt="<?php echo $branch->GetValue('alt_map') ?>" style="max-width: 100%;" class="img-thumbnail"> 
                                                        <?php } ?>
                                                    </span> 
                                                </li>
                                            </ul>
                                ...
                                <div class="da-form-row">
                                    <label class="da-form-label">อัพโหลดไฟล์ <span class="required">*</span></label>
                                    <div class="da-form-item large" id="filecopy"> <span class="formNote"><strong>Alt tag</strong> </span>
                                        <input type="text" placeholder="" name="alt_map" value="<?php echo $branch->GetValue('alt_map') ?>" >
                                        <input type="file" name="file_array_map[]" id="image_map"  class="span4"/>
                        ...
                        <tbody>
                            ...
                            while ($row = $db->FetchArray($query)) {
                                ...
                                <tr>
                                    ...
                                    <td class="center"  width=""><img src="<?php echo $branch->getDataDesc("image", "id = '" . $row['id'] . "'") == "" ? NO_IMAGE : ADDRESS_SLIDES . $branch->getDataDesc("image", "id = '" . $row['id'] . "'") ?>" style="height:70px; width:150px;" class="img-polaroid"></td>
