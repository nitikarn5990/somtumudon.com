    ...
    while ($row = $db->FetchArray($query)) {
        ?>
                                <tr onmouseover="this.className = 'yellowThing';"
                                    ...
                                    <td width="" class="center"><?php echo $row['status'] == '' || $row['status'] == 'ยังไม่ได้อ่าน' ? '<img src=' . ADDRESS_ASSETS . 'email-new.png width="35" height="35">' : '<img src=' . ADDRESS_ASSETS . 'email-old.png width="35" height="35">'; ?></td>

                                    <td><?php echo $row['txt_name']; ?></td>
                                    <td><?php echo $row['txt_subject']; ?></td>
                                 
                                    <td width="" class="center"><a href="<?php echo ADDRESS_ADMIN_CONTROL ?>contact_message&action=edit&id=<?php echo $row['id'] ?>" class="btn btn-primary btn-small"> เปิดดู</a> <a href="#" onclick="if (confirm('คุณต้องการลบข้อมูลนี้หรือใม่?') == true) {
