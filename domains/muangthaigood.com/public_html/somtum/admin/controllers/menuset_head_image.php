...
if ($_GET['action'] == "add" || $_GET['action'] == "edit") {
    ...
    ?>
            ...
            <div class="da-panel collapsible">
                <div class="da-panel-header"> <span class="da-panel-title"> <i class="icol-<?php echo ($menuset_head_image->GetPrimary() != '') ? 'application-edit' : 'add' ?>"></i> <?php echo ($menuset_head_image->GetPrimary() != '') ? 'แก้ไข' : 'เพิ่ม' ?> Head Image เซตอาหาร </span> </div>
