    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="da-panel collapsible">
                <div class="da-panel-header"> <span class="da-panel-title"> <i class="icol-<?php echo ($slides->GetPrimary() != '') ? 'application-edit' : 'add' ?>"></i> <?php echo ($slides->GetPrimary() != '') ? 'แก้ไข' : 'เพิ่ม' ?> ภาพหัวข้อ </span> </div>
...
<?php } else { ?>
    <div class="row-fluid">
        <div class="span12">
            ...
            ?>
            <div class="da-panel collapsible">
                <div class="da-panel-header"> <span class="da-panel-title"> <i class="icol-grid"></i> รูปภาพหัวข้อ ทั้งหมด </span> </div>
