        ...
        <div class="container-fluid">
            <div style="max-width: 974px;margin: auto;">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <div id="content">
                            <p>สิบกว่าปีก่อนนั้น เราเป็นเพียงรถเข็นที่ลูกค้ามาซื้อใส่ถุง เมื่อลูกค้าต้องต่อแถวรอคิวเราจึงเพิ่มโต๊ะแบบพับเก็บได้เพื่อให้บริการกันข้างถนน ต่อมามีลูกค้ามากขึ้นจึงได้เช่าตึกแถวบริเวณนั้นเพื่อเปิดเป็นร้าน ต่อมาสัญญาเช่าหมดอายุ พวกเราจึงตัดสินใจดัดแปลงบ้านที่อยู่ลึกเข้าไปในซอยทานตะวันเป็นร้าน ลูกค้าก็ยังตามเข้าไปทานแถมยังมีจำนวนเพิ่มขึ้นอีกมาก จนตัวบ้านต้องปรับปรุงเปลี่ยนแปลงอีกหลายครั้งเพื่อให้สอดคล้องกับจำนวนของลูกค้า นั้นเป็นที่มาของชื่อ ร้านส้มตำอุดร ซอยทานตะวัน

                                งานหลังบ้านนั้น เราใส่ใจในเรื่องวัตถุดิบมากเป็นพิเศษ แม้จะเป็นงานหนักแต่ยายจะลงมือคั่วข้าวคั่วเองทุกครั้ง ในแต่ละฤดู ปลาร้าที่ใช้นั้นถูกคัดสรรจากอีสานโดยการตระเวนชิมด้วยตัวเองจากหลายๆแหล่งเพื่อที่เราจะคัดนำมาปรุงเป็นปลาร้าสุกในขั้นต่อไป การจ่ายตลาดแต่ละวัน เราโชคดีที่มีพ่อค้าแม่ค้าหลายรายมาเสนอขายวัตถุดิบให้ ดังนั้นเราจึงสามารถเลือกวัตถุดิบที่สดใหม่และมีคุณภาพดีเหมาะกับอาหารอีสานได้ทุกวัน

                                หลายครั้งมีคนมาขอซื้อแฟรนไชน์ เราขอโทษจากใจแต่เราไม่สามารถขายให้ได้เพราะเราไม่มีสูตรจะขาย เราใช้การชิมเอาในแต่ละมื้อ ซึ่งอาศัยการฝึกหัดและประสบการณ์ผูกพันกับอาหารอีสานมาตั้งแต่เกิด ในความเชื่อของเรา ความงดงามของอาหารอีสานนั้นไม่ได้อยู่ที่หน้าตาของมันบนจาน แต่อยู่ที่ความง่ายและความกันเองของมันที่จะทะลุเข้าไปถึงใจของผู้กิน เหมือนกับแนวทางที่เราทำมาตลอดตั้งแต่สมัยที่เรายังเป็นร้านรถเข็นเล็กๆ "อร่อย สะอาด รสชาติเลือกได้"</p>
                        </div>
                        <div id="locationmenu">
                            <ul class="padding-all-0-xs">
                                <li>
                                    <h2><span class="hidden-lg hidden-md"><img src="images/location-pin.png">&nbsp;</span>สาขา สันติธรรม</h2>
                                    <p>เบอร์โทร. <span>094-4982363</span></p>
                                    <p>พิกัด. <span>09322255</span></p>
                                    <p>แผนที่. </p><br>
                                        <a href="#" id="trigger"><img src="images/branch1.jpg" width="100%;"></a>            </li>
                                <li><h2><span class="hidden-lg hidden-md"><img src="images/location-pin.png">&nbsp;</span>สาขา 2 แยกบวกครก</h2>
                                    <p>เบอร์โทร. 093-2<span>451009</span></p>
                                    <p>พิกัด. <span>09322255</span></p>
                                    <p>แผนที่. </p><br>
                                        <a href="#" id="trigger1"><img src="images/branch2.jpg" width="100%;"></a>            </li>
                                <li><h2><span class="hidden-lg hidden-md"><img src="images/location-pin.png">&nbsp;</span>สาขาป้าอ้วน</h2>
                                    <p>เบอร์โทร. <span>094-4982363</span></p>
                                    <p>พิกัด. <span>09322255</span></p>
                                    <p>แผนที่. </p><br>
                                        <a href="#" id="trigger2"><img src="images/branch3.jpg" width="100%;"></a></li>
                                <li><h2><span class="hidden-lg hidden-md"><img src="images/location-pin.png">&nbsp;</span>สาขากาดฝรั่ง</h2>
                                    <p>เบอร์โทร. <span>094-4982363</span></p>
                                    <p>พิกัด. <span>09322255</span></p>
                                    <p>แผนที่. </p><br>
                                        <a href="#" id="trigger3"><img src="images/branch4.jpg" width="100%;"></a>            </li>
                            </ul>
                            <div id="pop-up">
                                <img src="images/branch1.jpg" width="100%;">
                                    <h2><span class="hidden-lg hidden-md"><img src="images/location-pin.png">&nbsp;</span>สาขา สันติธรรม</h2>
                                    <p>เบอร์โทร. <span>094-4982363</span></p>
                                    <p>พิกัด. <span>09322255</span></p>
                            </div>
                            <div id="pop-up1">
                                <img src="images/branch2.jpg" width="100%;">
                                    <h2><span class="hidden-lg hidden-md"><img src="images/location-pin.png">&nbsp;</span>สาขา 2 แยกบวกครก</h2>
                                    <p>เบอร์โทร. 093-2<span>451009</span></p>
                                    <p>พิกัด. <span>09322255</span></p>
                            </div>
                            <div id="pop-up2">
                                <img src="images/branch3.jpg" width="100%;">
                                    <h2><span class="hidden-lg hidden-md"><img src="images/location-pin.png">&nbsp;</span>สาขาป้าอ้วน</h2>
                                    <p>เบอร์โทร. <span>094-4982363</span></p>
                                    <p>พิกัด. <span>09322255</span></p>
                            </div>
                            <div id="pop-up3">
                                <img src="images/branch4.jpg" width="100%;">
                                    <h2><span class="hidden-lg hidden-md"><img src="images/location-pin.png">&nbsp;</span>สาขากาดฝรั่ง</h2>
                                    <p>เบอร์โทร. <span>094-4982363</span></p>
                                    <p>พิกัด. <span>09322255</span></p>
                            </div>
                        </div>
                        ...
                        <div id="submenu">
                            <ul>
                                ...
                                <li><a href="location.html">สาขา / ที่ตั้ง</a></li>
                                <li><a href="menu.html">เมนู / ราคา</a></li>
                                <li><a href="service.html">ครัว / บริการ</a></li>
                                <li><a href="clients.html">ลูกค้า / คำติชม</a></li>
                            </ul>
                            <div class="clear"></div>
                        </div>
                        <div id="footer">
